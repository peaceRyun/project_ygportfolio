...
const Study = () => {
    ...
    const bentoH2 = 'font-bold text-[3.3rem] leading-[0.9]';
                ...
                <div className='grid-features grid grid-cols-[4fr_3fr_3fr] grid-rows-1 gap-x-8 gap-y-8 auto-cols-fr'>
                    ...
                    <div className={`${bentoCard} ${logo} bento-card logo`}>
                        <div className={`${bentoCardDes}`}>
                            ...
                            <p className={`${bentoP}`}></p>
                        </div>
                        오프라인 교육에서 실제 사람과의 대면을 통해 협업 프로젝트 경험을 해보며 개발 협업시 필요한
                        커뮤니케이션을 체득하고자 하였습니다.
                        <br />
                        <br />
                        또한, 끊임없이 배워야 하는 개발 지식은 공식 문서 기반의 다양한 글과 강의를 통해 기초 프로그래밍
                        언어 지식, 프레임워크 & 라이브러리의 적합한 활용 방법, 퍼블리싱 설계를 위한 UI/UX 지식,
                        웹접근성&웹표준성&SEO, 안정적인 비동기 통신&인증&베포에 대한 정보를 습득해보고 있습니다.
