export const portfoliodata = [
    ...
    },
    {
        ...
        process: [
            ...
            {
                title: '구현',
                desc: '앱의 사용성에 초점을 두어 첫 화면을 한눈에 들어오는 메뉴와 전광판으로 구성하였습니다. 기능에는 스트레스를 주제로 다방면으로 자신을 돌볼 수 있는 메뉴 구성을 하고자 하였습니다. 전광판 등록을 구현해보기 위해 CharkaUI의 탭 컴포넌트를 가져오는 시도를 하였고, 일기장을 구현하기 위해 CRUD에 해당하는 기능을 넣어보는 과정이 있었습니다. 요리 백과사전을 구현해보기 위해 공공API를 불러오는 것으로 기획하였습니다.',
            },
        ],
        keyFeatures: [
            {
