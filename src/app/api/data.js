export const portfoliodata = [
    ...
    keyFeatures: [
      {
        ...
        desc1:
          "- 인트로 영상을 scale 값을 조절하여 스크롤을 통해 더 확대될 수 있도록 설계하여 몰입감을 높였습니다. ",
        desc2:
          "- 사용자가 Pretcoord 소개 문구를 재미나게 읽을 수 있도록 스크롤 할때마다 글씨가 빛나게끔 구현하였습니다.",
      },
      {
        title: "반응형",
        video: "/projects/pretcoord/pretcoord-responsive.mp4",
        desc1:
          "모바일, 태블릿, 모니터 등 어떤 디바이스에서도 일관된 사용자 경험을 제공합니다. 글자들을 Clamp라는 css 함수를 통해 제어하면서 보다 효율적으로 반응형을 구현하면서 재미를 느꼈습니다",
      },
      {
        title: "부드러운 애니메이션",
        video: "/projects/pretcoord/pretcoord-hover.mp4",
        desc1:
          "링크 글씨 hover효과(Glow, line Effect)를 구현해보았습니다. UI적으로 화려한 두 hover효과에 대하여 디자인적으로 학습해보고 구현하는 방법도 알아갈 수 있었던 좋은 기회가 되었습니다.",
      },
    ],
    troubleShooting: [
      {
  ...
  },
  {
    ...
    figma:
      "https://www.figma.com/design/mseacF6eDnRzpwa9Uvzgr6/project2-sunfish?node-id=0-1&t=lQEK8zzdAbWtsgVh-1",
    ...
    keyFeatures: [
      {
        ...
        desc1:
          "기간, 메트릭스 우선순위 뿐만 아니라 지시한 사람까지 기록하면서 자동으로 정리되는 1순위를 간편하게 전광판에 등록해보세요!",
      },
      {
        title: "간편한 비스트레스성 요리 재료 검색과 관련 레시피를 손쉽게!",
        video: "/projects/sunfish/sunfish-food.mp4",
        desc1:
          "우울, 화남, 불안, 피곤의 대표적인 4가지 요인에 따른 비스트레스성 요리 재료를 검색해보고 관련 레시피를 손쉽게 찾아보세요!",
      },
      {
        title: "증상별 백과사전을 통해 본인의 몸을 되돌아 보아요!",
        video: "/projects/sunfish/sunfish-encyclopedia.mp4",
        desc1:
          "여드름, 목/어깨 통증, 소화장애, 대표 3가지 스트레스 증상들을 사전을 통해 배경지식을 쌓으며 몸을 풀어보세요!",
      },
      {
  ...
  },
  {
    ...
    figma:
      "https://www.figma.com/design/UFpbjWERXFC5aZUoy9A2zf/project1_3000bike-remake-with-html%2Fcss%2Fjs%2Bgsap?node-id=2001-31042&t=l8a6z3s12dIYSfsw-1",
    ...
    keyFeatures: [
      {
        ...
        desc1:
          "스크롤 할 때마다 툭툭 튀어나오는 고화질 사진들과 부드럽게 나오는 메세지를 통해 몰입감 있는 삼천리 자전거 브랜드 이미지를 경험할 수 있습니다.",
      },
      {
        title: "자전거에 대한 세밀한 선택이 가능한 상세페이지",
        video: "/projects/samchoen/samchoen-detail.mp4",
        desc1:
          "기존 사이트에서는 한눈에 보기 어려웠던 사이즈/컬러 선택을 한 페이지에 보기 쉽게 정리하였습니다. ",
      },
      {
        title: "웹접근성에 맞추기",
  ...
  },
  {
    ...
    figma:
      "https://www.figma.com/design/mmwiSjjdtvvVi1dB5dsiZt/D2C-Project?node-id=1-88&t=IsmeicsJpaB2Dogg-1",
    techStack: [
      "React",
      "Next.js",
      "Tailwind CSS",
    ...
    keyFeatures: [
      {
        ...
        img: "",
        desc1:
          "로컬스토리지 기반 로그인/회원가입 기능 구현, 세션 유지 및 마이페이지 기록 연동 구현",
      },
      {
        title: "제품 카테고리 필터링",
        img: "",
        desc1:
          "리스트페이지에서는 직관적인 4개의 카테고리로 구성하고, new, best, 가격순으로도 제품들을 볼 수 있습니다.",
        desc2:
          "검색 기능은 제품명 검색 외에도, 컬렉션명이나 시리즈명으로도 검색이 가능하도록 구현하였습니다.",
      },
      {
        title: "화려하면서 깔끔한 디자인 페이지",
        img: "",
        desc1:
          "로딩, 랜딩페이지, 전시회페이지, About페이지에서 Gsap을 활용한 깔끔한 스크롤 인터렉션 페이지를 만들어 사용자가 브랜드에 대해 보다 직관적이고 재밌게 접근하게 만들었습니다.",
      },
    ],
    troubleShooting: [
      {
  ...
  },
  {
    ...
    figma:
      "https://www.figma.com/design/2RnUhIuvGnwXrh5v91NX04/OTT-작업지침서?node-id=0-1&t=Vk9L49iYm3Ad85gQ-1",
    techStack: [
      "React",
      "Next.js",
      "Tailwind CSS",
    ...
    keyFeatures: [
      {
        ...
        desc1:
          "TMDB API를 활용하여 요일별 신작 Swiper, 인기 Top10 Swiper, 장르별 리스트, 검색, 애니메이션 Swiper, 다크한 분위기 영화 Swiper, 감성 드라마 Swiper 를 구현하였습니다. ",
      },
      {
        title:
          "로컬 스토리지 기반 로그인/회원가입, 프로필 아이콘, 마이페이지 기록 관리 기능 구현",
        video: "/projects/vibo/vibo-login.mp4",
        desc1:
          "Local Storage를 활용하여 로그인/회원가입 기능을 구현했습니다. 간단한 비밀번호 유효성 검사와 중복 닉네임 검사까지 구현하여 보안 강화와 가입 사용자에 대한 구별하였습니다.",
        desc2:
          "개인화된 기록관리를 할 수 있도록, 관심 콘텐츠, 시청 기록, 리뷰/평점 기록을 동적으로 그리고 한눈에 볼 수 있도록 구현하였습니다.",
        desc3:
          "프로필 아이콘 변경 페이지를 통해 디자이너가 직접 디자인한 아이콘을 선택하고 저장되도록 구현하였습니다.",
      },
      {
        title: "곳곳에 있는 사용자 인터렉션 요소",
        video: "/projects/vibo/vibo-interaction.mp4",
        desc1:
          "사용자가 사이트에 흥미를 느끼고, 군데군데 홍보 요소에 대해 거부감을 느끼지 않도록 애니메이션을 추가하였습니다.",
      },
    ],
    troubleShooting: [
      {
